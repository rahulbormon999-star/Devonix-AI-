...
-- ================= ডিভাইস তথ্য ও লোকেশন ফিচার বাদ দেওয়া হলো (প্রাইভেসির কারণে) =================
ALTER TABLE users DROP COLUMN IF EXISTS device_info;
ALTER TABLE users DROP COLUMN IF EXISTS screen_width;
ALTER TABLE users DROP COLUMN IF EXISTS screen_height;
ALTER TABLE users DROP COLUMN IF EXISTS last_ip;
ALTER TABLE users DROP COLUMN IF EXISTS last_login_at;
ALTER TABLE users DROP COLUMN IF EXISTS shared_latitude;
ALTER TABLE users DROP COLUMN IF EXISTS shared_longitude;
